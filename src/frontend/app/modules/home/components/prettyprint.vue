...
<template>
<div class="row">
    <textarea ref="codeholder"></textarea>
</div>
</template>
...
export default {
    ...
    mounted() {
        ...
        this.editor = window.CodeMirror.fromTextArea(codeholder, {
            ...
            mode: 'javascript',
            matchBrackets: true,
            theme: 'solarized' // potencijalne teme se nalaze https://github.com/codemirror/CodeMirror/tree/master/theme , te se mora kopirati css u style tag ove komponente
        });
