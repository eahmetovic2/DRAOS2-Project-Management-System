...
<page>
    <template v-if="ucitanZahtjev">
        <v-dialog v-if="ucitanZahtjev" v-model="ucitanZahtjev" @input="zatvoriDialogPregledZahtjev" max-width="1300px">

            <material-card class="dialog-card" color="primary">
                <v-flex slot="header">
                    <v-layout row justify-space-between>
                        <v-flex>
                            <span class="card-naslov">Pregled zadatka </span>
                        </v-flex>
                            ...
                            <v-menu open-on-hover offset-y class="toolbar-menu" bottom left content-class="dropdown-menu" transition="slide-y-transition">
                                ...
                                <v-list>
                                    <v-list-tile @click="otvoriEditZahtjeva">
                                        <v-list-tile-title>Izmjena zadatka</v-list-tile-title>
                                    </v-list-tile>
                                    <v-list-tile @click="otvoriHistorijuStatusaZahtjeva">
                                        <v-list-tile-title>Pregled promjena statusa zadatka</v-list-tile-title>
                                    </v-list-tile>
                                    <v-list-tile @click="otvoriDialogBrisanjeZahtjeva">
                                        <v-list-tile-title>Brisanje zadatka</v-list-tile-title>
                                    </v-list-tile>
                                </v-list>
                            </v-menu>
                        </v-flex>
                ...
                <v-card-text>
                    <v-layout>
                        <v-flex xs8 pr-5> 
                            <v-layout column>
                                <v-flex class="naslov-pregleda">{{ zahtjevModel.naziv }}</v-flex>                           
                                
                                <v-flex class="opis-zahtjeva">Opis</v-flex>
                                <v-flex class="opis-zahtjeva-text">{{ zahtjevModel.opis }}</v-flex>
                                <v-divider>  </v-divider>        
                        ...
                        <v-layout  column>                            
                            <table class="v-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Datum početka izrade: </td>
                                        <td>{{ zahtjevModel.pocetakIzrade.substring(8,10) + '. ' + zahtjevModel.pocetakIzrade.substring(5,7)+ '. '+zahtjevModel.pocetakIzrade.substring(0,4)}}</td>
                                    </tr>
